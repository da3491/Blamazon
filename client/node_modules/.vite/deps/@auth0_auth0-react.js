...
var r = { name: "auth0-spa-js", version: "2.0.2" };
var c = () => Date.now();
...
async function O(t2, i2) {
  ...
  return await async function(t3, i3, o3, n3, a3, s3, r2) {
    ...
    if (u3)
      throw u3;
    const l3 = c3.json, { error: h3, error_description: p2 } = l3, f2 = e(l3, ["error", "error_description"]), { ok: g2 } = c3;
    if (!g2) {
      const e2 = p2 || `HTTP error. Unable to fetch ${t3}`;
      if ("mfa_required" === h3)
        throw new m(h3, e2, f2.mfa_token);
...
var X = { get(e2) {
  ...
  let o2 = {};
  "https:" === window.location.protocol && (o2 = { secure: true, sameSite: "none" }), (null == i2 ? void 0 : i2.daysUntilExpire) && (o2.expires = i2.daysUntilExpire), (null == i2 ? void 0 : i2.cookieDomain) && (o2.domain = i2.cookieDomain), W(e2, JSON.stringify(t2), o2);
}, remove(e2, t2) {
  let i2 = {};
  (null == t2 ? void 0 : t2.cookieDomain) && (i2.domain = t2.cookieDomain), R(e2, i2);
} };
var V = { get(e2) {
  const t2 = X.get(e2);
  ...
  let o2 = {};
  "https:" === window.location.protocol && (o2 = { secure: true }), (null == i2 ? void 0 : i2.daysUntilExpire) && (o2.expires = i2.daysUntilExpire), W(`_legacy_${e2}`, JSON.stringify(t2), o2), X.save(e2, t2, i2);
}, remove(e2, t2) {
  let i2 = {};
  (null == t2 ? void 0 : t2.cookieDomain) && (i2.domain = t2.cookieDomain), R(e2, i2), X.remove(e2, t2), X.remove(`_legacy_${e2}`, t2);
} };
var D = { get(e2) {
...
var B = { memory: () => new z().enclosedCache, localstorage: () => new x() };
var q = (e2) => B[e2];
var Q = (t2) => {
